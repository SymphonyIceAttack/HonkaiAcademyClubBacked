-- CreateTable
CREATE TABLE "EquipMemntShare" (
    "id" TEXT NOT NULL,
    "MaskShare" TEXT NOT NULL,

    CONSTRAINT "EquipMemntShare_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "EquipMemntShare_MaskShare_key" ON "EquipMemntShare"("MaskShare");
